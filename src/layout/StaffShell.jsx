...
import { FiHome, FiList, FiBarChart2, FiGrid, FiUser, FiMessageSquare } from 'react-icons/fi';
...
const STAFF_NAV = [
  ...
  { to: '/staff/feedback', label: 'Feedback', icon: <FiMessageSquare />, capability: 'staff:reports' },
